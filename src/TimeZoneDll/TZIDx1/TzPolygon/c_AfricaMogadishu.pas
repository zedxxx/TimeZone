...
const
  cAfricaMogadishu_0: array [0..429] of TTimeZonePoint = (
    ...
    (X: 455; Y: 55), (X: 460; Y: 59), (X: 465; Y: 65), (X: 469; Y: 69),
    (X: 473; Y: 73), (X: 474; Y: 74), (X: 476; Y: 76), (X: 480; Y: 80),
    (X: 479; Y: 80), (X: 470; Y: 80), (X: 462; Y: 83), (X: 456; Y: 85),
    (X: 453; Y: 86), (X: 447; Y: 88), (X: 444; Y: 89), (X: 443; Y: 89),
    (X: 442; Y: 89), (X: 441; Y: 89), (X: 441; Y: 90), (X: 440; Y: 90),
    (X: 440; Y: 91), (X: 439; Y: 91), (X: 438; Y: 92), (X: 437; Y: 92),
    (X: 437; Y: 93), (X: 436; Y: 93), (X: 436; Y: 94), (X: 435; Y: 94),
    (X: 435; Y: 95), (X: 434; Y: 95), (X: 434; Y: 96), (X: 433; Y: 96),
    (X: 433; Y: 97), (X: 433; Y: 98), (X: 432; Y: 99), (X: 431; Y: 99),
    (X: 431; Y: 100), (X: 430; Y: 100), (X: 430; Y: 101), (X: 429; Y: 101),
    (X: 429; Y: 102), (X: 428; Y: 103), (X: 428; Y: 104), (X: 428; Y: 105),
    (X: 427; Y: 105), (X: 427; Y: 106), (X: 427; Y: 107), (X: 428; Y: 107),
    (X: 428; Y: 108), (X: 429; Y: 108), (X: 429; Y: 109), (X: 430; Y: 110),
    (X: 432; Y: 114), (X: 433; Y: 115)
  );

  cAfricaMogadishuPolygon: array[0..0] of TTimeZonePolygon = (
    (PointsCount: 430; FirstPoint: @cAfricaMogadishu_0[0])
  );
