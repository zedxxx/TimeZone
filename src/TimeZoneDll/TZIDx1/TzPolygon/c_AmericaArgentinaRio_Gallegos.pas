...
const
  cAmericaArgentinaRio_Gallegos_0: array [0..304] of TTimeZonePoint = (
    ...
    (X: -689; Y: -522), (X: -690; Y: -522), (X: -691; Y: -522), (X: -692; Y: -522),
    (X: -695; Y: -522), (X: -698; Y: -521), (X: -700; Y: -520), (X: -704; Y: -520),
    (X: -707; Y: -520), (X: -709; Y: -520), (X: -712; Y: -520), (X: -714; Y: -520),
    (X: -715; Y: -520), (X: -717; Y: -520), (X: -719; Y: -520), (X: -720; Y: -520),
    (X: -720; Y: -519), (X: -719; Y: -519), (X: -720; Y: -519), (X: -720; Y: -518),
    (X: -721; Y: -518), (X: -721; Y: -517), (X: -722; Y: -517), (X: -723; Y: -517),
    (X: -723; Y: -516), (X: -724; Y: -516), (X: -724; Y: -515), (X: -723; Y: -515),
    (X: -724; Y: -515), (X: -723; Y: -515), (X: -723; Y: -514), (X: -723; Y: -513),
    (X: -723; Y: -514), (X: -723; Y: -513), (X: -724; Y: -513), (X: -723; Y: -513),
    (X: -723; Y: -512), (X: -724; Y: -512), (X: -724; Y: -511), (X: -724; Y: -510),
    (X: -723; Y: -510), (X: -724; Y: -510), (X: -723; Y: -510), (X: -723; Y: -509),
    (X: -722; Y: -509), (X: -723; Y: -509), (X: -722; Y: -509), (X: -723; Y: -509),
    (X: -722; Y: -509), (X: -723; Y: -509), (X: -723; Y: -508), (X: -724; Y: -508),
    (X: -723; Y: -508), (X: -723; Y: -507), (X: -723; Y: -506), (X: -724; Y: -506),
    (X: -725; Y: -506), (X: -726; Y: -506), (X: -726; Y: -507), (X: -727; Y: -507),
    (X: -727; Y: -506), (X: -728; Y: -506), (X: -728; Y: -507), (X: -729; Y: -507),
    (X: -730; Y: -507), (X: -729; Y: -507), (X: -730; Y: -507), (X: -730; Y: -508),
    (X: -731; Y: -508), (X: -732; Y: -508), (X: -731; Y: -508), (X: -732; Y: -508),
    (X: -732; Y: -507), (X: -731; Y: -507), (X: -731; Y: -506), (X: -732; Y: -506),
    (X: -733; Y: -506), (X: -733; Y: -505), (X: -734; Y: -505), (X: -733; Y: -505),
    (X: -734; Y: -505), (X: -734; Y: -504), (X: -734; Y: -503), (X: -734; Y: -502),
    (X: -735; Y: -502), (X: -734; Y: -502), (X: -735; Y: -502), (X: -734; Y: -502),
    (X: -735; Y: -502), (X: -735; Y: -501), (X: -735; Y: -500), (X: -735; Y: -501),
    (X: -735; Y: -500), (X: -734; Y: -500), (X: -735; Y: -500), (X: -736; Y: -499),
    (X: -735; Y: -499), (X: -735; Y: -498), (X: -734; Y: -498), (X: -735; Y: -498),
    (X: -731; Y: -492), (X: -731; Y: -491), (X: -730; Y: -491), (X: -730; Y: -490),
    (X: -729; Y: -490), (X: -730; Y: -490), (X: -729; Y: -490), (X: -729; Y: -489),
    (X: -729; Y: -490), (X: -728; Y: -490), (X: -728; Y: -489), (X: -727; Y: -489),
    (X: -726; Y: -489), (X: -726; Y: -488), (X: -725; Y: -488), (X: -725; Y: -487),
    (X: -725; Y: -486), (X: -726; Y: -486), (X: -726; Y: -485), (X: -725; Y: -485),
    (X: -724; Y: -485), (X: -724; Y: -484), (X: -723; Y: -484), (X: -724; Y: -484),
    (X: -724; Y: -483), (X: -724; Y: -484), (X: -724; Y: -483), (X: -723; Y: -483),
    (X: -723; Y: -484), (X: -722; Y: -483), (X: -722; Y: -484), (X: -722; Y: -483),
    (X: -723; Y: -483), (X: -723; Y: -482), (X: -723; Y: -481), (X: -724; Y: -481),
    (X: -724; Y: -480), (X: -725; Y: -480), (X: -725; Y: -479), (X: -725; Y: -478),
    (X: -725; Y: -477), (X: -725; Y: -478), (X: -725; Y: -477), (X: -724; Y: -477),
    (X: -725; Y: -477), (X: -724; Y: -477), (X: -724; Y: -476), (X: -723; Y: -476),
    (X: -723; Y: -475), (X: -723; Y: -474), (X: -723; Y: -475), (X: -723; Y: -474),
    (X: -723; Y: -475), (X: -723; Y: -474), (X: -722; Y: -474), (X: -723; Y: -474),
    (X: -722; Y: -474), (X: -721; Y: -474), (X: -722; Y: -474), (X: -721; Y: -474),
  ...
  cAmericaArgentinaRio_GallegosPolygon: array[0..0] of TTimeZonePolygon = (
    (PointsCount: 305; FirstPoint: @cAmericaArgentinaRio_Gallegos_0[0])
  );
