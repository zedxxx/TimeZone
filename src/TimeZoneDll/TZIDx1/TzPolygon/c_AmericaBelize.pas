...
const
  ...
  cAmericaBelize_1: array [0..68] of TTimeZonePoint = (
    ...
    (X: -892; Y: 163), (X: -892; Y: 164), (X: -892; Y: 168), (X: -892; Y: 171),
    (X: -891; Y: 171), (X: -891; Y: 173), (X: -891; Y: 174), (X: -891; Y: 175),
    (X: -891; Y: 176), (X: -891; Y: 177), (X: -891; Y: 178), (X: -892; Y: 179),
    (X: -891; Y: 179), (X: -891; Y: 180), (X: -890; Y: 180), (X: -890; Y: 179),
    (X: -890; Y: 180), (X: -889; Y: 180), (X: -889; Y: 179), (X: -888; Y: 179),
    (X: -888; Y: 180), (X: -887; Y: 180), (X: -887; Y: 181), (X: -887; Y: 182),
    (X: -886; Y: 182)
  );

  cAmericaBelizePolygon: array[0..1] of TTimeZonePolygon = (
    (PointsCount: 9; FirstPoint: @cAmericaBelize_0[0]), 
    (PointsCount: 69; FirstPoint: @cAmericaBelize_1[0])
  );
