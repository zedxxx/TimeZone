...
const
  cAmericaBlancSablon_0: array [0..54] of TTimeZonePoint = (
    ...
    (X: -569; Y: 513), (X: -579; Y: 509), (X: -601; Y: 493), (X: -612; Y: 486),
    (X: -612; Y: 502), (X: -612; Y: 518), (X: -612; Y: 520)
  );

  cAmericaBlancSablonPolygon: array[0..0] of TTimeZonePolygon = (
    (PointsCount: 55; FirstPoint: @cAmericaBlancSablon_0[0])
  );
