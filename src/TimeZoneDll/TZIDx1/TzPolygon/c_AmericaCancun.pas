...
const
  ...
  cAmericaCancun_26: array [0..139] of TTimeZonePoint = (
    ...
    (X: -891; Y: 179), (X: -891; Y: 178), (X: -894; Y: 178), (X: -894; Y: 182),
    (X: -894; Y: 183), (X: -894; Y: 184), (X: -894; Y: 185), (X: -894; Y: 186),
    (X: -894; Y: 187), (X: -894; Y: 188), (X: -894; Y: 190), (X: -894; Y: 191),
    (X: -894; Y: 194), (X: -894; Y: 195), (X: -894; Y: 196), (X: -894; Y: 197),
    (X: -893; Y: 198), (X: -890; Y: 199), (X: -889; Y: 200), (X: -888; Y: 200),
    (X: -886; Y: 201), (X: -886; Y: 202), (X: -885; Y: 202), (X: -883; Y: 203),
    (X: -881; Y: 204), (X: -879; Y: 206), (X: -878; Y: 207), (X: -877; Y: 207),
    (X: -877; Y: 208), (X: -876; Y: 209), (X: -875; Y: 210), (X: -875; Y: 215)
  );
  ...
  cAmericaCancunPolygon: array[0..26] of TTimeZonePolygon = (
    ...
    (PointsCount: 140; FirstPoint: @cAmericaCancun_26[0])
  );
