...
const
  cAmericaIndianaVevay_0: array [0..11] of TTimeZonePoint = (
    (X: -852; Y: 387), (X: -852; Y: 389), (X: -851; Y: 389), (X: -850; Y: 389),
    (X: -849; Y: 389), (X: -848; Y: 389), (X: -848; Y: 388), (X: -849; Y: 388),
    (X: -850; Y: 388), (X: -850; Y: 387), (X: -851; Y: 387), (X: -852; Y: 387)
  );

  cAmericaIndianaVevayPolygon: array[0..0] of TTimeZonePolygon = (
    (PointsCount: 12; FirstPoint: @cAmericaIndianaVevay_0[0])
  );
