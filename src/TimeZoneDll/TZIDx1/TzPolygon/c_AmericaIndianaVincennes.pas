...
const
  cAmericaIndianaVincennes_0: array [0..43] of TTimeZonePoint = (
    (X: -877; Y: 384), (X: -877; Y: 385), (X: -878; Y: 385), (X: -877; Y: 385),
    (X: -876; Y: 385), (X: -877; Y: 385), (X: -877; Y: 386), (X: -876; Y: 386),
    (X: -876; Y: 387), (X: -875; Y: 387), (X: -875; Y: 388), (X: -875; Y: 389),
    (X: -876; Y: 389), (X: -875; Y: 389), (X: -874; Y: 389), (X: -872; Y: 389),
  ...
  cAmericaIndianaVincennesPolygon: array[0..0] of TTimeZonePolygon = (
    (PointsCount: 44; FirstPoint: @cAmericaIndianaVincennes_0[0])
  );
