...
const
  cAmericaIndianaWinamac_0: array [0..14] of TTimeZonePoint = (
    (X: -865; Y: 409), (X: -866; Y: 409), (X: -867; Y: 409), (X: -868; Y: 409),
    (X: -869; Y: 409), (X: -869; Y: 410), (X: -869; Y: 411), (X: -869; Y: 412),
    (X: -868; Y: 412), (X: -867; Y: 412), (X: -866; Y: 412), (X: -865; Y: 412),
    (X: -865; Y: 411), (X: -865; Y: 410), (X: -865; Y: 409)
  );
