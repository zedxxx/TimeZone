...
const
  ...
  cAmericaTijuana_10: array [0..2] of TTimeZonePoint = (
  ...
  cAmericaTijuana_12: array [0..1] of TTimeZonePoint = (
    (X: -1135; Y: 290), (X: -1135; Y: 290)
  );

  cAmericaTijuana_13: array [0..2] of TTimeZonePoint = (
    (X: -1135; Y: 290), (X: -1135; Y: 291), (X: -1135; Y: 290)
  );

  cAmericaTijuana_14: array [0..1] of TTimeZonePoint = (
    (X: -1135; Y: 290), (X: -1135; Y: 290)
  );
  ...
  cAmericaTijuana_30: array [0..10] of TTimeZonePoint = (
  ...
  cAmericaTijuana_31: array [0..25] of TTimeZonePoint = (
  ...
  cAmericaTijuana_32: array [0..188] of TTimeZonePoint = (
    (X: -1147; Y: 327), (X: -1148; Y: 327), (X: -1148; Y: 326), (X: -1148; Y: 325),
    (X: -1148; Y: 324), (X: -1149; Y: 324), (X: -1149; Y: 323), (X: -1150; Y: 323),
    ...
    (X: -1131; Y: 280), (X: -1133; Y: 280), (X: -1136; Y: 280), (X: -1137; Y: 280),
    (X: -1139; Y: 280), (X: -1142; Y: 280), (X: -1141; Y: 281), (X: -1141; Y: 282),
    (X: -1141; Y: 283), (X: -1141; Y: 284), (X: -1140; Y: 284), (X: -1140; Y: 285),
    (X: -1141; Y: 285), (X: -1141; Y: 286), (X: -1142; Y: 286), (X: -1141; Y: 286),
    (X: -1142; Y: 286), (X: -1142; Y: 287), (X: -1143; Y: 287), (X: -1143; Y: 288),
    (X: -1144; Y: 288), (X: -1144; Y: 289), (X: -1145; Y: 289), (X: -1145; Y: 290),
    (X: -1146; Y: 290), (X: -1146; Y: 291), (X: -1147; Y: 291), (X: -1147; Y: 292),
    (X: -1148; Y: 292), (X: -1148; Y: 293), (X: -1149; Y: 293), (X: -1150; Y: 294),
    (X: -1151; Y: 294), (X: -1152; Y: 294), (X: -1152; Y: 295), (X: -1153; Y: 295),
    (X: -1153; Y: 296), (X: -1154; Y: 296), (X: -1155; Y: 296), (X: -1155; Y: 297),
    (X: -1156; Y: 297), (X: -1157; Y: 297), (X: -1157; Y: 298), (X: -1157; Y: 299),
    (X: -1157; Y: 300), (X: -1158; Y: 300), (X: -1158; Y: 299), (X: -1158; Y: 300),
    (X: -1158; Y: 301), (X: -1158; Y: 302), (X: -1158; Y: 303), (X: -1159; Y: 304),
    (X: -1160; Y: 304), (X: -1160; Y: 305), (X: -1160; Y: 306), (X: -1160; Y: 307),
    (X: -1160; Y: 308), (X: -1161; Y: 308), (X: -1162; Y: 309), (X: -1163; Y: 310),
    (X: -1163; Y: 311), (X: -1163; Y: 312), (X: -1164; Y: 312), (X: -1164; Y: 313),
    (X: -1165; Y: 313), (X: -1165; Y: 314), (X: -1166; Y: 315), (X: -1167; Y: 315),
    (X: -1167; Y: 316), (X: -1167; Y: 315), (X: -1167; Y: 316), (X: -1166; Y: 316),
    (X: -1167; Y: 316), (X: -1166; Y: 316), (X: -1166; Y: 317), (X: -1167; Y: 317),
  ...
  cAmericaTijuanaPolygon: array[0..32] of TTimeZonePolygon = (
    ...
    (PointsCount: 3; FirstPoint: @cAmericaTijuana_10[0]), 
    (PointsCount: 2; FirstPoint: @cAmericaTijuana_11[0]), 
    (PointsCount: 2; FirstPoint: @cAmericaTijuana_12[0]), 
    (PointsCount: 3; FirstPoint: @cAmericaTijuana_13[0]), 
    (PointsCount: 2; FirstPoint: @cAmericaTijuana_14[0]), 
    ...
    (PointsCount: 11; FirstPoint: @cAmericaTijuana_30[0]), 
    (PointsCount: 26; FirstPoint: @cAmericaTijuana_31[0]), 
    (PointsCount: 189; FirstPoint: @cAmericaTijuana_32[0])
  );
