...
const
  cAsiaDamascus_0: array [0..290] of TTimeZonePoint = (
    ...
    (X: 383; Y: 331), (X: 382; Y: 331), (X: 381; Y: 330), (X: 380; Y: 330),
    (X: 379; Y: 329), (X: 378; Y: 329), (X: 378; Y: 328), (X: 377; Y: 328),
    (X: 377; Y: 327), (X: 376; Y: 327), (X: 375; Y: 327), (X: 374; Y: 326),
    (X: 373; Y: 326), (X: 372; Y: 326), (X: 372; Y: 325), (X: 371; Y: 325),
    (X: 371; Y: 324), (X: 370; Y: 324), (X: 369; Y: 324), (X: 369; Y: 323),
    (X: 368; Y: 323), (X: 367; Y: 323), (X: 366; Y: 323), (X: 365; Y: 324),
    (X: 364; Y: 324), (X: 363; Y: 324), (X: 363; Y: 325), (X: 362; Y: 325),
    (X: 361; Y: 325), (X: 361; Y: 326), (X: 360; Y: 326), (X: 360; Y: 327),
    (X: 359; Y: 327), (X: 358; Y: 327), (X: 358; Y: 328)
  );

  cAsiaDamascusPolygon: array[0..0] of TTimeZonePolygon = (
    (PointsCount: 291; FirstPoint: @cAsiaDamascus_0[0])
  );
