...
const
  cEuropeSkopje_0: array [0..112] of TTimeZonePoint = (
    ...
    (X: 208; Y: 421), (X: 209; Y: 421), (X: 210; Y: 421), (X: 210; Y: 422),
    (X: 211; Y: 422), (X: 212; Y: 422), (X: 212; Y: 421), (X: 213; Y: 421),
    (X: 213; Y: 422), (X: 214; Y: 422), (X: 214; Y: 423), (X: 215; Y: 423),
    (X: 215; Y: 422), (X: 215; Y: 423), (X: 216; Y: 423), (X: 216; Y: 422),
    (X: 216; Y: 423), (X: 216; Y: 422), (X: 217; Y: 422), (X: 217; Y: 423),
    (X: 218; Y: 423), (X: 219; Y: 423), (X: 220; Y: 423), (X: 221; Y: 423),
    (X: 222; Y: 423), (X: 222; Y: 424), (X: 222; Y: 423), (X: 222; Y: 424),
    (X: 223; Y: 424), (X: 223; Y: 423), (X: 224; Y: 423), (X: 224; Y: 422),
    (X: 225; Y: 422), (X: 224; Y: 422), (X: 225; Y: 422), (X: 225; Y: 421),
    (X: 226; Y: 421), (X: 227; Y: 421), (X: 227; Y: 420), (X: 228; Y: 420),
    (X: 229; Y: 420), (X: 229; Y: 419), (X: 229; Y: 418), (X: 230; Y: 418),
    (X: 230; Y: 417)
  );

  cEuropeSkopjePolygon: array[0..0] of TTimeZonePolygon = (
    (PointsCount: 113; FirstPoint: @cEuropeSkopje_0[0])
  );
