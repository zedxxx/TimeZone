...
const
  ...
  cPacificGuadalcanal_2: array [0..55] of TTimeZonePoint = (
    (X: 1562; Y: -64), (X: 1564; Y: -64), (X: 1565; Y: -64), (X: 1566; Y: -64),
    (X: 1567; Y: -64), (X: 1567; Y: -65), (X: 1579; Y: -70), (X: 1582; Y: -71),
    (X: 1587; Y: -73), (X: 1588; Y: -73), (X: 1589; Y: -74), (X: 1590; Y: -76),
    (X: 1604; Y: -77), (X: 1606; Y: -77), (X: 1607; Y: -77), (X: 1608; Y: -77),
    (X: 1608; Y: -78), (X: 1612; Y: -85), (X: 1621; Y: -96), (X: 1622; Y: -96),
  ...
  cPacificGuadalcanal_3: array [0..14] of TTimeZonePoint = (
  ...
  cPacificGuadalcanal_5: array [0..17] of TTimeZonePoint = (
  ...
  cPacificGuadalcanal_6: array [0..16] of TTimeZonePoint = (
  ...
  cPacificGuadalcanal_7: array [0..23] of TTimeZonePoint = (
  ...
  cPacificGuadalcanal_8: array [0..22] of TTimeZonePoint = (
  ...
  cPacificGuadalcanalPolygon: array[0..9] of TTimeZonePolygon = (
    ...
    (PointsCount: 15; FirstPoint: @cPacificGuadalcanal_3[0]), 
    (PointsCount: 18; FirstPoint: @cPacificGuadalcanal_4[0]), 
    (PointsCount: 18; FirstPoint: @cPacificGuadalcanal_5[0]), 
    (PointsCount: 17; FirstPoint: @cPacificGuadalcanal_6[0]), 
    (PointsCount: 24; FirstPoint: @cPacificGuadalcanal_7[0]), 
    (PointsCount: 23; FirstPoint: @cPacificGuadalcanal_8[0]), 
