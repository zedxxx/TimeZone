...
const
  ...
  cAfricaCeuta_3: array [0..2] of TTimeZonePoint = (
    (X: -242; Y: 3518), (X: -242; Y: 3519), (X: -242; Y: 3518)
  );

  cAfricaCeuta_4: array [0..2] of TTimeZonePoint = (
  ...
  cAfricaCeuta_7: array [0..38] of TTimeZonePoint = (
  ...
  cAfricaCeuta_8: array [0..34] of TTimeZonePoint = (
  ...
  cAfricaCeuta_9: array [0..18] of TTimeZonePoint = (
  ...
  cAfricaCeutaPolygon: array[0..9] of TTimeZonePolygon = (
    ...
    (PointsCount: 3; FirstPoint: @cAfricaCeuta_3[0]), 
    (PointsCount: 3; FirstPoint: @cAfricaCeuta_4[0]), 
    (PointsCount: 3; FirstPoint: @cAfricaCeuta_5[0]), 
    (PointsCount: 2; FirstPoint: @cAfricaCeuta_6[0]), 
    (PointsCount: 39; FirstPoint: @cAfricaCeuta_7[0]), 
    (PointsCount: 35; FirstPoint: @cAfricaCeuta_8[0]), 
    (PointsCount: 19; FirstPoint: @cAfricaCeuta_9[0])
  );
