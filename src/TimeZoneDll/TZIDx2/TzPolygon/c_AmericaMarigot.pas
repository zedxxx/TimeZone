...
const
  cAmericaMarigot_0: array [0..38] of TTimeZonePoint = (
    ...
    (X: -6304; Y: 1806), (X: -6305; Y: 1806), (X: -6306; Y: 1806), (X: -6307; Y: 1806),
    (X: -6308; Y: 1806), (X: -6308; Y: 1805), (X: -6309; Y: 1805), (X: -6310; Y: 1805),
    (X: -6311; Y: 1805), (X: -6313; Y: 1805), (X: -6314; Y: 1805)
  );
