...
const
  cAsiaHong_Kong_0: array [0..70] of TTimeZonePoint = (
    ...
    (X: 11395; Y: 2247), (X: 11395; Y: 2248), (X: 11400; Y: 2251), (X: 11401; Y: 2250),
  ...
  cAsiaHong_KongPolygon: array[0..0] of TTimeZonePolygon = (
    (PointsCount: 71; FirstPoint: @cAsiaHong_Kong_0[0])
  );
